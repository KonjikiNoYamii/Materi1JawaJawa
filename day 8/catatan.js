...
let pilihGenre = genreFilm.map(function(item,index,array) { // untuk mengambil keseluruhan array ke array baru
...
let absenIstri = paraIstri.forEach(function(item,index,array) { // melooping sebuah array
...
let ratakanDanBuat =numberArray.flatMap(item => { //flat map cuma bisa meratakan 1 level saja
    return [ item * 2]
})
